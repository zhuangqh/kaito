...
var _ = Describe("Workspace Preset on vllm runtime", func() {
	...
	It("should create a deepseek-distilled-qwen-14b workspace with preset public mode successfully", utils.GinkgoLabelOffline, func() {
		numOfNode := 1
	...
	It("should create a phi4 workspace with adapter successfully", utils.GinkgoLabelOffline, func() {
		numOfNode := 1
	...
	It("should create a llama-3.3-70b-instruct workspace with preset public mode successfully", utils.GinkgoLabelOffline, func() {
