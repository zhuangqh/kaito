...
func NewArcSKUHandler() CloudSKUHandler {
	return &generalSKUHandler{
		...
		supportedSKUs: map[string]GPUConfig{
			...
			"Standard_NC16_A2":  {SKU: "Standard_NC16_A2", GPUCount: 2, GPUMemGB: 48, GPUModel: "NVIDIA A2"},
			"Standard_NC32_A2":  {SKU: "Standard_NC32_A2", GPUCount: 2, GPUMemGB: 48, GPUModel: "NVIDIA A2"},
			...
			"Standard_NC16_A16": {SKU: "Standard_NC16_A16", GPUCount: 2, GPUMemGB: 48, GPUModel: "NVIDIA A16"},
			"Standard_NC32_A16": {SKU: "Standard_NC32_A16", GPUCount: 2, GPUMemGB: 48, GPUModel: "NVIDIA A16"},
		},
	}
}
