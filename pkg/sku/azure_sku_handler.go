...
func NewAzureSKUHandler() CloudSKUHandler {
	supportedSKUs := []GPUConfig{
		...
		{SKU: "Standard_NC64as_T4_v3", GPUCount: 4, GPUMemGiB: 64, GPUModel: "NVIDIA T4"},
		{SKU: "Standard_NV36ads_A10_v5", GPUCount: 1, GPUMemGiB: 24, GPUModel: "NVIDIA A10"},
		{SKU: "Standard_NV72ads_A10_v5", GPUCount: 2, GPUMemGiB: 48, GPUModel: "NVIDIA A10"},
		{SKU: "Standard_NC24ads_A100_v4", GPUCount: 1, GPUMemGiB: 80, GPUModel: "NVIDIA A100", NVMeDiskEnabled: true},
		{SKU: "Standard_NC48ads_A100_v4", GPUCount: 2, GPUMemGiB: 160, GPUModel: "NVIDIA A100", NVMeDiskEnabled: true},
		{SKU: "Standard_NC96ads_A100_v4", GPUCount: 4, GPUMemGiB: 320, GPUModel: "NVIDIA A100", NVMeDiskEnabled: true},
		{SKU: "Standard_ND96asr_A100_v4", GPUCount: 8, GPUMemGiB: 320, GPUModel: "NVIDIA A100"},
		{SKU: "Standard_ND96amsr_A100_v4", GPUCount: 8, GPUMemGiB: 640, GPUModel: "NVIDIA A100", NVMeDiskEnabled: true},
		// https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/ncadsh100v5-series
		{SKU: "Standard_NC40ads_H100_v5", GPUCount: 1, GPUMemGiB: 94, GPUModel: "NVIDIA H100", NVMeDiskEnabled: true},
		{SKU: "Standard_NC80adis_H100_v5", GPUCount: 2, GPUMemGiB: 188, GPUModel: "NVIDIA H100", NVMeDiskEnabled: true},
		// https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/ndh100v5-series
		{SKU: "Standard_ND96isr_H100_v5", GPUCount: 8, GPUMemGiB: 640, GPUModel: "NVIDIA H100", NVMeDiskEnabled: true},
		// https://learn.microsoft.com/en-us/azure/virtual-machines/sizes/gpu-accelerated/nccadsh100v5-series
		{SKU: "Standard_NCC40ads_H100_v5", GPUCount: 1, GPUMemGiB: 94, GPUModel: "NVIDIA H100"},
		...
		{SKU: "Standard_NV32as_v4", GPUCount: 1, GPUMemGiB: 16, GPUModel: "AMD Radeon Instinct MI25"},
